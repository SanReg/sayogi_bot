...
A personal assistant Telegram bot powered by various models via **OpenRouter**, built with Node.js and Express.

## Features
- **Conversational AI:** Chats with you like a real assistant using OpenRouter models.
- **Context Aware:** Remembers the last 20 messages of the conversation.
- **Smart Reminders:** Uses Tool Calling capabilities to natively understand when you ask it to remind you about something, and schedules it automatically.
